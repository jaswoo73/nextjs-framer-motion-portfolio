          ...
          <motion.div style={{ x }} className="flex">
            ...
            {works.map((item) => (
              <div
                ...
                key={item.id}
              >
                <div className="flex flex-col gap-8 text-white bg-orange-200">
                  ...
                  <Link href={item.link} className="flex justify-end">
                    <button className="p2- text-sm md:p-4 md:text-md lg:p-6 lg:text-lg bg-white backdrop-blur-md bg-opacity-20 text-white font-semibold m-4 rounded hover:text-white hover:bg-orange-300 transition-all">
                      See Demo
                    </button>
                  </Link>
                </div>
